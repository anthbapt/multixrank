...
htmlhelp_basename = 'multixrankdoc'
...
latex_documents = [
    (master_doc, 'multixrank.tex', 'multixrank Documentation',
     'Anthony Baptista, Aitor González, Anaïs Baudot', 'manual'),
]
...
man_pages = [
    (master_doc, 'multixrank', 'multixrank Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'multixrank', 'multixrank Documentation',
     author, 'multixrank', 'One line description of project.',
     'Miscellaneous'),
]
